...
function Home() {
  return (
    ...
    >
      ...
      >
        Hi I'm <span className='text-teal-400'>PRIYANSHU NAGDA</span>
      </motion.h1>
      ...
      >
        Designing secure and stunning web experiences with a blend of modern frontend technologies and cybersecurity best practices.
      </motion.p>
