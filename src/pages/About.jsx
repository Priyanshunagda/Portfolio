...
import { FaReact, FaPython, FaPhp, FaJava, FaGithub, FaAngular } from "react-icons/fa";
import { SiJavascript, SiPostman, SiVercel, SiCplusplus } from "react-icons/si";
        ...
        >
            ...
            >
                <div className="flex flex-col items-center justify-center">
                    ...
                    <p>
                        Frontend software engineer with a strong passion for
                        clean UI/UX and modern web technologies.
                    </p>
                    <p>
                        Also a cybersecurity enthusiast, eager to build secure
            ...
            {/* Degrees Section */}
            <h2 className="text-2xl font-bold text-center text-teal-300 mb-6">
                Education
            </h2>
            ...
            {/* Tools Section */}
            <h2 className="text-2xl text-center font-bold text-teal-300 mb-6">
                Tools
            </h2>
